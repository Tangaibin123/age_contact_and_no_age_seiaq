...
# plt.bar(age_brackets,Baseline_group_incidence,label='Baseline',color='coral')
# plt.bar(age_brackets,NPI_group_incidence,label='NPI')
fig, ax = plt.subplots(figsize=(6,6))
ax.bar(age_brackets,agegroup)
ax.set_xticklabels(age_brackets, rotation=90)
...
file_name = f'age_distribution.pdf'
